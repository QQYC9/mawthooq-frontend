...
const News = () => {
  ...
  useEffect(() => {
    ...
    const mockNews = [
      ...
      // أخبار جديدة عن الفرص الاستثمارية
      {
        id: 4,
        title: 'إطلاق مشروع إنتاج الألبان ومشتقاتها',
        excerpt: 'فرصة استثمارية واعدة في قطاع الألبان لتحقيق الاكتفاء الذاتي وتلبية الطلب المحلي.',
        category: 'فرص استثمارية',
        author: 'هيئة الاستثمار اليمنية',
        date: '2024-06-20',
        image: 'dairy-production.jpg',
        featured: false
      },
      {
        id: 5,
        title: 'فرصة استثمارية في زراعة وإنتاج البن اليمني',
        excerpt: 'مشروع مميز لتوسيع إنتاج البن اليمني الشهير وتصديره للأسواق العالمية.',
        category: 'فرص استثمارية',
        author: 'هيئة الاستثمار اليمنية',
        date: '2024-06-20',
        image: 'coffee-farming.jpg',
        featured: false
      },
      {
        id: 6,
        title: 'محطة توليد الكهرباء الغازية: استثمار في الطاقة المستدامة',
        excerpt: 'مشروع ضخم لإنشاء محطة كهرباء تعمل بالغاز الطبيعي لتلبية احتياجات السوق المحلي من الطاقة.',
        category: 'فرص استثمارية',
        author: 'هيئة الاستثمار اليمنية',
        date: '2024-06-20',
        image: 'gas-power-plant.jpg',
        featured: false
      },
      {
        id: 7,
        title: 'إطلاق مشروع إنتاج الدواجن اللاحم',
        excerpt: 'مشروع جديد لإنتاج لحوم الدواجن بجودة عالية لتغطية احتياجات السوق المحلي.',
        category: 'فرص استثمارية',
        author: 'هيئة الاستثمار اليمنية',
        date: '2024-06-21',
        image: 'broiler-chicken-production.jpg',
        featured: false
      },
      {
        id: 8,
        title: 'مشروع إنتاج وتعبئة العسل اليمني',
        excerpt: 'فرصة استثمارية مميزة لإنتاج وتعبئة العسل اليمني الطبيعي عالي الجودة.',
        category: 'فرص استثمارية',
        author: 'هيئة الاستثمار اليمنية',
        date: '2024-06-21',
        image: 'honey-production.jpg',
        featured: false
      },
      {
        id: 9,
        title: 'مشروع صناعة الأدوية البشرية',
        excerpt: 'مشروع ضخم لصناعة الأدوية البشرية وتغطية احتياجات السوق المحلي من الأدوية.',
        category: 'فرص استثمارية',
        author: 'هيئة الاستثمار اليمنية',
        date: '2024-06-21',
        image: 'pharmaceuticals-production.jpg',
        featured: false
      }
    ];
